        ...
        <div className='flex flex-row items-center justify-center text-center'>
          <div className='grid grid-cols-2 xs:grid-cols-2 ss:grid-cols-2 sm:grid-cols-3 md:grid-cols-3  lg:grid-cols-4 items-center gap-14 w-full text-primary'>
            ...
            {AssingnmentList.map((assignmentObj, index) => (
                ...
                <div className='w-28 h-28 bg-violet-300 bg-opacity-60 dark:bg-blue-300 dark:bg-opacity-60 border border-violet-900 dark:border-blue-900 ss:w-40 ss:h-40 sm:w-48 sm:h-48 md:w-64 md:h-48 lg:w-72 lg:h-48 flex items-center justify-center rounded-xl cursor-pointer transition-transform duration-300 hover:scale-105' onClick={() => {UpdateCurrentOpenedAssignment(assignmentObj.id)}}>
