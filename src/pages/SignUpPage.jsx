    ...
    return (
        <div className={!isDark && 'dark'}>
            <section className='bg-white dark:bg-primary w-full h-screen flex flex-col md:flex-row items-start font-poppins'>
                {/* Student Section */}
                <div className='bg-primary dark:bg-white relative w-full md:w-1/2 h-full flex flex-col'>
                    ...
                    <div className='flex flex-1 flex-col items-center justify-center '>
                        ...
                        <button className='w-[200px] text-white dark:text-primary bg-primary dark:bg-white rounded-lg border-lg border-white dark:border-primary border p-4 text-center mt-4 mb-20'>
                            Student
                        </button>
                    </div>
                </div>
                ...
                <div className='relative w-full md:w-1/2 h-full flex flex-col items-center justify-center'>
                    <div className='flex flex-1 flex-col items-center justify-center '>
                        ...
                        <button className='w-[200px] text-primary dark:text-white bg-white dark:bg-primary rounded-lg border-lg border-primary border dark:border-white p-4 text-center mt-4'>
                            Teacher
                        </button>
