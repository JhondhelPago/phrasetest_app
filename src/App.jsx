...
import TeacherExamineResults from './pages/TeacherExamineResult';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/teacher/examineresults" element={<TeacherExamineResults isDark={isDark} changeColorTheme={changeColorTheme}></TeacherExamineResults>}></Route>
